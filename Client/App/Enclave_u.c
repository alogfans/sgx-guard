...
sgx_status_t enclave_ra_create(sgx_enclave_id_t eid, sgx_status_t* retval, int b_pse, uint32_t* context)
{
	sgx_status_t status;
	ms_enclave_ra_create_t ms;
	ms.ms_b_pse = b_pse;
...
sgx_status_t enclave_ra_close(sgx_enclave_id_t eid, sgx_status_t* retval, uint32_t context)
{
	sgx_status_t status;
...
sgx_status_t enclave_ra_set_remote_pubkey(sgx_enclave_id_t eid, sgx_status_t* retval, sgx_ec256_public_t pubkey)
{
	sgx_status_t status;
	ms_enclave_ra_set_remote_pubkey_t ms;
	ms.ms_pubkey = pubkey;
...
sgx_status_t enclave_seal_aes_key(sgx_enclave_id_t eid, sgx_status_t* retval, uint8_t* aes_key, uint32_t sealed_size, uint8_t* sealed)
{
	sgx_status_t status;
	ms_enclave_seal_aes_key_t ms;
...
sgx_status_t enclave_seal_size(sgx_enclave_id_t eid, int* retval, uint32_t payload_size)
{
	sgx_status_t status;
	ms_enclave_seal_size_t ms;
